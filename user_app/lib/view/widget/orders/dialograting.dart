import 'package:user_app/controller/orders/archive_controller.dart';
...
void showDialogRating(BuildContext context, int ordersid){
  ...
  showDialog(
    ...
    builder: (context) => RatingDialog(
      ...
      submitButtonTextStyle: const TextStyle(color: AppColor.primaryColor, fontWeight: FontWeight.bold),
      onSubmitted: (response) {
        OrdersArchiveController controller = Get.find();
        controller.submitRating(ordersid.toString(), response.rating.toString(), response.comment);
